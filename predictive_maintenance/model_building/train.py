...
LOCAL_DATA_DIR = Path("predictive_maintenance/data")
...
mlflow_tracking_uri = "file:./predictive_maintenance/mlruns"
...
model_path = "predictive_maintenance/model_building/best_decision_tree_model.pkl"
joblib.dump(best_model, model_path)
print(f"Tuned Decision Tree model saved to {model_path}")

cv_results_path = "predictive_maintenance/model_building/grid_search_results.csv"
...
HF_UPLOAD_PATH_IN_REPO = os.getenv("HF_UPLOAD_PATH_IN_REPO", "best_decision_tree_model.pkl")
