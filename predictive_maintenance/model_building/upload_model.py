...
MODEL_PATH = Path("predictive_maintenance/model_building/best_decision_tree_model.pkl")
HF_SPACE_ID = (
    os.getenv("HF_SPACE_ID")
    or os.getenv("HF_UPLOAD_REPO_ID")
    or "nikhileshmehta1989/Predictive_Maintenance_Vehicle"
)
HF_UPLOAD_PATH_IN_REPO = os.getenv("HF_UPLOAD_PATH_IN_REPO", MODEL_PATH.name)
